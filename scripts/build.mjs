...
for(const name of ['index.html','privacy.html','update.html','styles.css','favicon.svg','manifest.webmanifest','sw.js','src']) {
...
for(const name of ['index.html','privacy.html','update.html','styles.css','favicon.svg','manifest.webmanifest',...fs.readdirSync('src').sort().map(name=>'src/'+name)])digest.update(fs.readFileSync(path.join(output,name)));
