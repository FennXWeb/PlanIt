// Only the public app shell is cached. Personal workspace data never enters a request.
const CACHE='planit-shell-v1';
const FILES=['./','./index.html','./styles.css','./favicon.svg','./manifest.webmanifest','./src/app.js','./src/theme.css','./src/welcome.js','./src/data.js','./src/engine.js','./src/storage.js','./src/demo.js'];
